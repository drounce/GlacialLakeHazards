...
Lake_Level = 4819; % Input lake level based on average from ASTER GDEM
Expansion_Rate = 0.376606386996; % km2 / 15 yr
    Expansion_Rate_Pixels = round(Expansion_Rate/(30*30*1/1000^2));
Lake_Number = 31; % Number for subset area (N1, N2, etc.), not all lakes
...
Tif_Output_FileName = 'N2_LakeYear_2015_2045_Lumding';
