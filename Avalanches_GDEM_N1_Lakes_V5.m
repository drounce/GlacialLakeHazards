...
%% Import DEM, Prone Areas, and Flow Accumulation
    Lake_Table = xlsread('N1_Lakes_AvalancheResults_Pt1km2_V4.xls');
        n_Lakes = size(Lake_Table,1);
    DEM = imread('N1_ASTER_Elev_V2.tif');
        DEM = double(DEM);
        nrows = size(DEM,1);
        ncols = size(DEM,2);
    FlowDir = imread('N1_ASTER_FlowDir_V2.tif');
...
Tif_Output_FileName = 'N1_GDEM_AvalancheTrajectories_10_30_50m';
Tif_Output_FilePath = '\Users\dave\Documents\Dave_Rounce\_Desktop_Files_20170519\MATLAB\Nepal_Hazards\Tiff_Files';
Tif_Input_FilePath = Tif_Output_FilePath;
Tif_Input_FileName = 'N1_ASTER_Elev_V2.tif';
