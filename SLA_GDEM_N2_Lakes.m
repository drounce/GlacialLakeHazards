...
DEM = imread('N2_Lakes_ASTER_Elev.tif');
    ...
    nrows = size(DEM,1);
    ncols = size(DEM,2);
Lake_2000 = imread('N2_2000_GlacialLakes_minPt1km2_V3_raster.tif');
    Lake_2000 = double(Lake_2000);
Lake_2015 = imread('N2_2015_GlacialLakes_minPt1km2_V3_raster_export.tif');
...
% Lake_Lower = min(SLA_AvgAngle_max_Hp,Depth_mean);
% 
% if SLA_deg_max >= 10
